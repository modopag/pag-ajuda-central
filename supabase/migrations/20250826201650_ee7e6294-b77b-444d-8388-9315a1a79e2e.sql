-- Corrigir função generate_base_slug com search_path seguro
...
-- Corrigir função generate_unique_slug com search_path seguro
...
-- Corrigir função auto_generate_slug com search_path seguro
